...
cp "$SCRIPT_DIR/temp/$first_hash-$second_hash/${first_hash}_functions-crossclones/${first_hash}_functions-crossclones-0.30-classes-withsource.html" $output_file
